...
def main():
    ...
    if income_data:
        ...
        print(f"营业收入: {revenue / 10000:.2f} 亿元")
        print(f"营业成本: {oper_cost / 10000:.2f} 亿元")
        print(f"营业利润: {operate_profit / 10000:.2f} 亿元")
        print(f"利润总额: {total_profit / 10000:.2f} 亿元")
        print(f"净利润(不含少数): {n_income / 10000:.2f} 亿元")
        print(f"基本每股收益: {latest.get('基本每股收益') or 0:.2f} 元")
        print(f"销售费用: {(latest.get('销售费用') or 0) / 10000:.2f} 亿元")
        print(f"管理费用: {(latest.get('管理费用') or 0) / 10000:.2f} 亿元")
        print(f"研发费用: {(latest.get('研发费用') or 0) / 10000:.2f} 亿元")
        print(f"财务费用: {(latest.get('财务费用') or 0) / 10000:.2f} 亿元")
